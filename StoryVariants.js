/**
 * StoryVariants — хранит три полных сценария игры.
 *
 * Каждый сценарий содержит:
 *   culprit       — ключ виноватого
 *   interrogations — полные данные допросов (заменяет window.interrogations)
 *   endings       — тексты финала для каждого обвиняемого
 *
 * OCP: новый сценарий = новый объект в массиве, логика не меняется.
 */
window.StoryVariants = [

    // =========================================================
    // СЦЕНАРИЙ 1 — виновен АСИСТЕНТ
    // =========================================================
    {
        culprit: "assistant",
